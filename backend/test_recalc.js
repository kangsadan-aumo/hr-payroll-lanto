...
async function test() {
    ...
    try {
        console.log('🔄 Starting test recalculation...');
        ...
        const [employees] = await pool.query('SELECT id, join_date FROM employees WHERE status = "active" LIMIT 10'); // limit for speed
